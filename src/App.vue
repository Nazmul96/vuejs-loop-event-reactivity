      ...
      <div class="w-6/12 mx-auto rounded border">
        <div class="bg-white p-10 shadow-sm">
          ...
          <div class="transition hover:bg-indigo-50">
            ...
            <!-- Content -->
            <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="1==accordionIndex">
              <p class="leading-6 font-light pl-9 ">
          ...
          <div class="transition hover:bg-indigo-50">
            ...
            <!-- Content -->
            <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="2==accordionIndex">
              <p class="leading-6 font-light pl-9">
          ...
          <div class="transition hover:bg-indigo-50">
            ...
            <!-- Content -->
            <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="3==accordionIndex">
              <p class="leading-6 font-light pl-9">
